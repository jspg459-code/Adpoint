...
,
  ...
  "Bonjour": P("Hello","Hola","Hallo","Ciao","Olá","Hallo","مرحبًا"),
  ...
  "Il sera affiché à la place de ton adresse e-mail. Tu pourras le modifier plus tard depuis ton profil.": P("It will be displayed instead of your email address. You can change it later from your profile.","Se mostrará en lugar de tu correo electrónico. Podrás cambiarlo más tarde desde tu perfil.","Er wird anstelle deiner E-Mail-Adresse angezeigt. Du kannst ihn später in deinem Profil ändern.","Verrà visualizzato al posto della tua email. Potrai modificarlo più tardi dal tuo profilo.","Ele será exibido no lugar do seu e-mail. Você poderá alterá-lo mais tarde no seu perfil.","Het wordt weergegeven in plaats van je e-mailadres. Je kunt het later in je profiel wijzigen.","سيتم عرضه بدلًا من بريدك الإلكتروني ويمكنك تغييره لاحقًا من ملفك الشخصي."),
  "Boutique d’échange": P("Rewards shop","Tienda de recompensas","Prämienshop","Negozio premi","Loja de recompensas","Beloningswinkel","متجر المكافآت"),
  "🛍️ Parcourir la boutique": P("🛍️ Browse the shop","🛍️ Explorar la tienda","🛍️ Shop durchsuchen","🛍️ Esplora il negozio","🛍️ Explorar a loja","🛍️ Winkel bekijken","🛍️ تصفح المتجر"),
  "Découvre les récompenses disponibles et échange tes AdPoints contre les offres proposées.": P("Discover available rewards and exchange your AdPoints for offers.","Descubre las recompensas disponibles y cambia tus AdPoints por ofertas.","Entdecke verfügbare Belohnungen und tausche deine AdPoints gegen Angebote.","Scopri le ricompense disponibili e scambia i tuoi AdPoints con le offerte.","Descubra as recompensas disponíveis e troque seus AdPoints por ofertas.","Ontdek beschikbare beloningen en wissel je AdPoints in voor aanbiedingen.","اكتشف المكافآت المتاحة واستبدل نقاط AdPoints بالعروض."),
  "Voir la boutique d’échange →": P("View rewards shop →","Ver la tienda →","Prämienshop ansehen →","Vedi il negozio premi →","Ver loja de recompensas →","Beloningswinkel bekijken →","عرض متجر المكافآت ←"),
  "BOUTIQUE D’ÉCHANGE": P("REWARDS SHOP","TIENDA DE RECOMPENSAS","PRÄMIENSHOP","NEGOZIO PREMI","LOJA DE RECOMPENSAS","BELONINGSWINKEL","متجر المكافآت"),
  "Échange tes": P("Exchange your","Cambia tus","Tausche deine","Scambia i tuoi","Troque seus","Wissel je","استبدل"),
  "Parcours les récompenses disponibles et utilise tes points pour obtenir les offres proposées.": P("Browse available rewards and use your points to get the offered rewards.","Explora las recompensas disponibles y usa tus puntos para obtener las ofertas.","Durchsuche verfügbare Belohnungen und nutze deine Punkte für Angebote.","Sfoglia le ricompense disponibili e usa i tuoi punti per ottenere le offerte.","Explore as recompensas disponíveis e use seus pontos para obter as ofertas.","Bekijk beschikbare beloningen en gebruik je punten voor de aanbiedingen.","تصفح المكافآت المتاحة واستخدم نقاطك للحصول على العروض."),
  "Ton solde disponible": P("Your available balance","Tu saldo disponible","Dein verfügbares Guthaben","Il tuo saldo disponibile","Seu saldo disponível","Je beschikbare saldo","رصيدك المتاح"),
  "Créer une offre d’échange": P("Create a reward offer","Crear una oferta de recompensa","Prämienangebot erstellen","Crea un'offerta premio","Criar uma oferta de recompensa","Een beloningsaanbieding maken","إنشاء عرض مكافأة"),
  "Cette offre sera visible dans la boutique pour les utilisateurs.": P("This offer will be visible to users in the shop.","Esta oferta será visible para los usuarios en la tienda.","Dieses Angebot wird für Benutzer im Shop sichtbar sein.","Questa offerta sarà visibile agli utenti nel negozio.","Esta oferta ficará visível para os usuários na loja.","Deze aanbieding wordt zichtbaar voor gebruikers in de winkel.","سيكون هذا العرض مرئيًا للمستخدمين في المتجر."),
  "Nom de l’offre": P("Offer name","Nombre de la oferta","Angebotsname","Nome dell'offerta","Nome da oferta","Naam van de aanbieding","اسم العرض"),
  "Description": P("Description","Descripción","Beschreibung","Descrizione","Descrição","Beschrijving","الوصف"),
  "Coût en AdPoints": P("Cost in AdPoints","Costo en AdPoints","Kosten in AdPoints","Costo in AdPoints","Custo em AdPoints","Kosten in AdPoints","التكلفة بنقاط AdPoints"),
  "Stock": P("Stock","Stock","Bestand","Disponibilità","Estoque","Voorraad","المخزون"),
  "Offres disponibles": P("Available offers","Ofertas disponibles","Verfügbare Angebote","Offerte disponibili","Ofertas disponíveis","Beschikbare aanbiedingen","العروض المتاحة"),
  "Choisis une offre et échange tes AdPoints.": P("Choose an offer and exchange your AdPoints.","Elige una oferta y cambia tus AdPoints.","Wähle ein Angebot und tausche deine AdPoints.","Scegli un'offerta e scambia i tuoi AdPoints.","Escolha uma oferta e troque seus AdPoints.","Kies een aanbieding en wissel je AdPoints in.","اختر عرضًا واستبدل نقاط AdPoints الخاصة بك."),
  "Mode créateur": P("Creator mode","Modo creador","Erstellermodus","Modalità creatore","Modo criador","Maker-modus","وضع المنشئ"),
  "Chargement des offres...": P("Loading offers...","Cargando ofertas...","Angebote werden geladen...","Caricamento offerte...","Carregando ofertas...","Aanbiedingen laden...","جارٍ تحميل العروض..."),
  "La boutique est prête": P("The shop is ready","La tienda está lista","Der Shop ist bereit","Il negozio è pronto","A loja está pronta","De winkel is klaar","المتجر جاهز"),
  "← Retour au tableau de bord": P("← Back to dashboard","← Volver al panel","← Zurück zum Dashboard","← Torna al dashboard","← Voltar ao painel","← Terug naar dashboard","→ العودة إلى لوحة التحكم"),
  "🗑️ Supprimer l’offre": P("🗑️ Delete offer","🗑️ Eliminar oferta","🗑️ Angebot löschen","🗑️ Elimina offerta","🗑️ Excluir oferta","🗑️ Aanbieding verwijderen","🗑️ حذف العرض"),
  "Échange bientôt": P("Exchange coming soon","Intercambio próximamente","Tausch bald verfügbar","Scambio presto disponibile","Troca em breve","Binnenkort inwisselen","التبادل قريبًا"),
  "Commence à gagner des AdPoints.": P("Start earning AdPoints.","Empieza a ganar AdPoints.","Beginne, AdPoints zu verdienen.","Inizia a guadagnare AdPoints.","Comece a ganhar AdPoints.","Begin AdPoints te verdienen.","ابدأ في كسب نقاط AdPoints."),
  ...
  "Aucun message reçu": P("No messages received","No se recibieron mensajes","Keine Nachrichten erhalten","Nessun messaggio ricevuto","Nenhuma mensagem recebida","Geen berichten ontvangen","لا توجد رسائل واردة"),
  "Les utilisateurs qui t'écriront apparaîtront ici.": P("Users who write to you will appear here.","Los usuarios que te escriban aparecerán aquí.","Benutzer, die dir schreiben, erscheinen hier.","Gli utenti che ti scriveranno appariranno qui.","Os usuários que escreverem para você aparecerão aqui.","Gebruikers die je schrijven verschijnen hier.","سيظهر هنا المستخدمون الذين يكتبون إليك."),
  "← Retour aux messages": P("← Back to messages","← Volver a los mensajes","← Zurück zu Nachrichten","← Torna ai messaggi","← Voltar às mensagens","← Terug naar berichten","→ العودة إلى الرسائل"),
  "Conversation utilisateur": P("User conversation","Conversación de usuario","Benutzerunterhaltung","Conversazione utente","Conversa do usuário","Gebruikersgesprek","محادثة المستخدم"),
  "Actualiser": P("Refresh","Actualizar","Aktualisieren","Aggiorna","Atualizar","Vernieuwen","تحديث"),
  "Aucun message": P("No messages","Sin mensajes","Keine Nachrichten","Nessun messaggio","Nenhuma mensagem","Geen berichten","لا توجد رسائل"),
  ...
  "Modifiable dans": P("Changeable in","Modificable en","Änderbar in","Modificabile tra","Alterável em","Wijzigbaar over","قابل للتعديل خلال"),
  ...
  "✓ Pseudo disponible": P("✓ Username available","✓ Nombre disponible","✓ Benutzername verfügbar","✓ Nome utente disponibile","✓ Nome disponível","✓ Gebruikersnaam beschikbaar","✓ اسم المستخدم متاح"),
  "Ton pseudo est visible sur AdPoints. Ton e-mail reste privé.": P("Your username is visible on AdPoints. Your email remains private.","Tu nombre de usuario es visible en AdPoints. Tu correo permanece privado.","Dein Benutzername ist auf AdPoints sichtbar. Deine E-Mail bleibt privat.","Il tuo nome utente è visibile su AdPoints. La tua email resta privata.","Seu nome de usuário é visível no AdPoints. Seu e-mail permanece privado.","Je gebruikersnaam is zichtbaar op AdPoints. Je e-mail blijft privé.","اسم المستخدم الخاص بك ظاهر على AdPoints ويبقى بريدك الإلكتروني خاصًا."),
  "Aucun joueur à classer pour le moment.": P("No players to rank at the moment.","No hay jugadores para clasificar por el momento.","Derzeit keine Spieler zum Ranglisten.","Nessun giocatore da classificare al momento.","Nenhum jogador para classificar no momento.","Momenteel geen spelers om te rangschikken.","لا يوجد لاعبون للتصنيف حاليًا."),
  "Toi": P("You","Tú","Du","Tu","Você","Jij","أنت"),
  "💡 Gagne des AdPoints en réalisant les activités disponibles pour monter dans le classement.": P("💡 Earn AdPoints by completing available activities to climb the ranking.","💡 Gana AdPoints realizando las actividades disponibles para subir en la clasificación.","💡 Verdiene AdPoints durch verfügbare Aktivitäten und steige in der Rangliste auf.","💡 Guadagna AdPoints completando le attività disponibili per salire in classifica.","💡 Ganhe AdPoints realizando as atividades disponíveis para subir no ranking.","💡 Verdien AdPoints door beschikbare activiteiten te voltooien en stijg in de ranglijst.","💡 اكسب نقاط AdPoints من خلال الأنشطة المتاحة للتقدم في الترتيب.")
,
  "Chargement du panel administrateur...": P("Loading admin panel...","Cargando panel de administración...","Admin-Panel wird geladen...","Caricamento pannello amministratore...","Carregando painel administrativo...","Beheerpaneel laden...","جارٍ تحميل لوحة الإدارة..."),
  "Panel": P("Panel","Panel","Panel","Pannello","Painel","Paneel","لوحة"),
  "administrateur": P("administrator","administrador","Administrator","amministratore","administrador","beheerder","المسؤول"),
  "Gestion complète et sécurisée des comptes AdPoints.": P("Complete and secure management of AdPoints accounts.","Gestión completa y segura de las cuentas AdPoints.","Vollständige und sichere Verwaltung der AdPoints-Konten.","Gestione completa e sicura degli account AdPoints.","Gerenciamento completo e seguro das contas AdPoints.","Volledig en veilig beheer van AdPoints-accounts.","إدارة كاملة وآمنة لحسابات AdPoints."),
  "Utilisateurs": P("Users","Usuarios","Benutzer","Utenti","Usuários","Gebruikers","المستخدمون"),
  "Comptes bannis": P("Banned accounts","Cuentas bloqueadas","Gesperrte Konten","Account bannati","Contas banidas","Verbannen accounts","الحسابات المحظورة"),
  "Comptes suspendus": P("Suspended accounts","Cuentas suspendidas","Gesperrte Konten","Account sospesi","Contas suspensas","Opgeschorte accounts","الحسابات الموقوفة"),
  ...
  "Personnes en ligne": P("People online","Personas en línea","Personen online","Persone online","Pessoas online","Mensen online","الأشخاص المتصلون"),
  "Voir qui est en ligne →": P("See who is online →","Ver quién está en línea →","Sehen, wer online ist →","Vedi chi è online →","Ver quem está online →","Bekijk wie online is →","عرض المتصلين ←"),
  "Gère les bannissements et les suspensions. Le créateur et les admins peuvent désuspendre un utilisateur.": P("Manage bans and suspensions. The creator and admins can unsuspend a user.","Gestiona bloqueos y suspensiones. El creador y los administradores pueden reactivar a un usuario.","Verwalte Sperren und Aussetzungen. Ersteller und Admins können Benutzer entsperren.","Gestisci ban e sospensioni. Il creatore e gli admin possono riattivare un utente.","Gerencie banimentos e suspensões. O criador e admins podem reativar um usuário.","Beheer bans en schorsingen. De maker en admins kunnen een gebruiker weer activeren.","إدارة الحظر والإيقاف. يمكن للمنشئ والمسؤولين إلغاء إيقاف المستخدم."),
  ...
  "Annuler": P("Cancel","Cancelar","Abbrechen","Annulla","Cancelar","Annuleren","إلغاء"),
  "Modifier les AdPoints": P("Edit AdPoints","Modificar AdPoints","AdPoints ändern","Modifica AdPoints","Editar AdPoints","AdPoints wijzigen","تعديل نقاط AdPoints"),
  "Ajoute ou retire des AdPoints sans modifier le pseudo.": P("Add or remove AdPoints without changing the username.","Añade o elimina AdPoints sin modificar el nombre.","Füge AdPoints hinzu oder entferne sie, ohne den Benutzernamen zu ändern.","Aggiungi o rimuovi AdPoints senza modificare il nome utente.","Adicione ou remova AdPoints sem alterar o nome de usuário.","Voeg AdPoints toe of verwijder ze zonder de gebruikersnaam te wijzigen.","أضف أو أزل نقاط AdPoints دون تغيير اسم المستخدم."),
  "Solde actuel :": P("Current balance:","Saldo actual:","Aktuelles Guthaben:","Saldo attuale:","Saldo atual:","Huidig saldo:","الرصيد الحالي:"),
  "Variation des AdPoints": P("AdPoints adjustment","Variación de AdPoints","AdPoints-Anpassung","Variazione AdPoints","Variação de AdPoints","AdPoints-aanpassing","تعديل نقاط AdPoints"),
  "Nombre positif = ajouter • Nombre négatif = retirer": P("Positive number = add • Negative number = remove","Número positivo = añadir • Número negativo = quitar","Positive Zahl = hinzufügen • Negative Zahl = entfernen","Numero positivo = aggiungi • Numero negativo = rimuovi","Número positivo = adicionar • Número negativo = remover","Positief getal = toevoegen • Negatief getal = verwijderen","رقم موجب = إضافة • رقم سالب = إزالة"),
  "Valider les points": P("Confirm points","Confirmar puntos","Punkte bestätigen","Conferma punti","Confirmar pontos","Punten bevestigen","تأكيد النقاط"),
  "Aucune personne en ligne": P("No one online","Nadie en línea","Niemand online","Nessuno online","Ninguém online","Niemand online","لا أحد متصل"),
  "La liste se met automatiquement à jour.": P("The list updates automatically.","La lista se actualiza automáticamente.","Die Liste wird automatisch aktualisiert.","L'elenco si aggiorna automaticamente.","A lista é atualizada automaticamente.","De lijst wordt automatisch bijgewerkt.","يتم تحديث القائمة تلقائيًا."),
  "Actif maintenant": P("Active now","Activo ahora","Jetzt aktiv","Attivo ora","Ativo agora","Nu actief","نشط الآن"),
  "Choisis la durée du bannissement. Les comptes peuvent ensuite être débannis.": P("Choose the ban duration. Accounts can later be unbanned.","Elige la duración del bloqueo. Las cuentas podrán desbloquearse después.","Wähle die Sperrdauer. Konten können später entsperrt werden.","Scegli la durata del ban. Gli account possono essere riattivati successivamente.","Escolha a duração do banimento. As contas poderão ser desbanidas depois.","Kies de duur van de ban. Accounts kunnen later worden vrijgegeven.","اختر مدة الحظر. يمكن إلغاء حظر الحسابات لاحقًا."),
  "Durée du bannissement": P("Ban duration","Duración del bloqueo","Sperrdauer","Durata del ban","Duração do banimento","Ban-duur","مدة الحظر"),
  "1 heure": P("1 hour","1 hora","1 Stunde","1 ora","1 hora","1 uur","ساعة واحدة"),
  "24 heures": P("24 hours","24 horas","24 Stunden","24 ore","24 horas","24 uur","24 ساعة"),
  "7 jours": P("7 days","7 días","7 Tage","7 giorni","7 dias","7 dagen","7 أيام"),
  "30 jours": P("30 days","30 días","30 Tage","30 giorni","30 dias","30 dagen","30 يومًا"),
  "Durée personnalisée": P("Custom duration","Duración personalizada","Benutzerdefinierte Dauer","Durata personalizzata","Duração personalizada","Aangepaste duur","مدة مخصصة"),
  "Minutes": P("Minutes","Minutos","Minuten","Minuti","Minutos","Minuten","دقائق"),
  "Heures": P("Hours","Horas","Stunden","Ore","Horas","Uren","ساعات"),
  "Jours": P("Days","Días","Tage","Giorni","Dias","Dagen","أيام"),
  "Raison": P("Reason","Motivo","Grund","Motivo","Motivo","Reden","السبب"),
  "BAN DÉF": P("PERM BAN","BAN PERM.","DAUERHAFTE SPERRE","BAN PERM.","BAN PERM.","PERM BAN","حظر دائم"),
  "Journal de l’activité": P("Activity log","Registro de actividad","Aktivitätsprotokoll","Registro attività","Registro de atividade","Activiteitenlog","سجل النشاط"),
  "Journal des utilisateurs": P("User log","Registro de usuarios","Benutzerprotokoll","Registro utenti","Registro de usuários","Gebruikerslog","سجل المستخدمين"),
